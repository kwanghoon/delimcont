...
-- Tests (many of which by Oleg Kiselyov)
...
group1 = [test1,test2,test3,test4,test5,
          test6,test7,test8,test9,test10,
          test11,test12,test13,test17]
ans1 = [5,9,9,9,27,
        -9,35,117,115,115,
        15,135,135,2]

group2 = [test14,test15,test16]
ans2 = [["a"],[],["a"]]

group3 = [test18,test19]
ans3 = [[1,2,3,4,5],[5,4,3,2,1]]
...
-- All the following return errors
...
main = putStrLn "Hello Delimited Continuations!"
